    ...
    return (
        <div className='interview-page'>
            ...
            <header className="mobile-header">
                ...
                <h1 className="mobile-header__title">Interview Report</h1>
            </header>
            ...
            <div className='interview-layout'>
                ...
                {/* ── Sidebar Nav ── */}
                <nav className={`interview-nav ${isSidebarOpen ? 'interview-nav--open' : ''}`}>
                        ...
                        <section className="analysis-view">
                            ...
                            <div className="analysis-grid">
                                ...
                                <div className='match-score-card'>
                                    ...
                                    <p className='sub'>Strong match for this role</p>
                                </div>
